...
sleep2: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms
	...
	jal UNTRACK # keep old track
	jal TRACK # and draw new track line
goASKEW1: addi $a0, $zero, 162 # Marsbot rotates 180*
	jal ROTATE
sleep3: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms
	...
	jal UNTRACK # keep old track
	jal TRACK # and draw new track line
goASKEW2: addi $a0, $zero, 306 # Marsbot rotates 180*
	jal ROTATE
sleep4: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms
	...
	jal UNTRACK # keep old track
	jal TRACK # and draw new track line
goRIGHT1: addi $a0, $zero, 90 # Marsbot rotates 270*
	jal ROTATE
sleep5: addi $v0,$zero,32 # Keep running by sleeping in 1000 ms
	...
	jal UNTRACK # keep old track
	jal TRACK # and draw new track line
goASKEW3: addi $a0, $zero, 234 # Marsbot rotates 180*
	jal ROTATE
sleep6: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms
	...
	jal UNTRACK # keep old track
	jal TRACK # and draw new track line
goASKEW4: addi $a0, $zero, 18 # Marsbot rotates 180*
	jal ROTATE
sleep7: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms
	li $a0,5000
	syscall
	jal UNTRACK # keep old track
sleep8: addi $v0,$zero,32 # Keep running by sleeping in 1000 ms
	li $a0,2000
	syscall
	jal UNTRACK # keep old track
	jal STOP
